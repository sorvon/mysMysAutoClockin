...
class ConfMeta(type):
  ...
  @property
  def ua(self):
    return 'Mozilla/5.0 (Linux; Android 11; Mi 10 Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/99.0.4844.73 Mobile Safari/537.36' \
           ' miHoYoBBS/%s' %(self.app_version)
